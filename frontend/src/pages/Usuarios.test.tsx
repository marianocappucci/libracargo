...
beforeEach(() => {
  ...
  get.mockResolvedValue([
    ...
    { id: '2', username: 'marta', name: 'Marta Operadora', role: 'staff', active: true, email: '' },
  ])
})
...
describe('pantalla de usuarios', () => {
  ...
  it('el botón «Eliminar» aparece en otro usuario, pero no en la fila propia', async () => {
    render(<Usuarios />)
    await screen.findByText('Marta Operadora')
    ...
    expect(screen.getByLabelText('Eliminar Marta Operadora')).toBeInTheDocument()
